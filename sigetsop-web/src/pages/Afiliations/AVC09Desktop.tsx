...
const AVC09Desktop: React.FC = () => {
    ...
    try {
      ...
      ws.onmessage = (event) => {
        ...
        if (data.type === "image_received") {
          ...
          // Mantenemos el token actual para permitir múltiples subidas ráfaga
          // setSessionTokenKey(null); 
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="dark:text-white mb-4">Opción 2: Enlace Móvil por QR 📱</h2>
        {sessionTokenKey && sessionId ? (
          <>
            ...
            />
            <button
              onClick={() => setSessionTokenKey(null)}
              className="mt-4 text-sm text-blue-600 hover:text-blue-800 dark:text-blue-400 flex items-center justify-center w-full gap-2 transition-colors"
            >
          ...
          <div className="flex flex-col items-center gap-3 py-6">
            ...
            <p className="text-gray-500 animate-pulse">Generando nuevo código de sesión...</p>
          </div>
        )}
      </div>
